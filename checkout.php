...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(name, number, email, method, street,city, pin_code, total_products, total_price) VALUES('$name','$number','$email','$method','$street','$city','$pin_code','$total_product','$price_total')") or die('query failed');
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='order-detail'>
            <p>".$total_product."</p>
            <h2 class='total'> total : $".$price_total."/- </h2>
         </div>
         <div class='customer-details'>
            <p> your name :".$name." </p>
            <p> your number : ".$number." </p>
            <p> your email : ".$email."</p>
            <p> your address :".$street.", ".$city." - ".$pin_code." </p>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="time" placeholder="Time" name="pin_code" required>
         </div>
      </div>
